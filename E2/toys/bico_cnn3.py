...
# Hyperparameters
num_epochs = 10  # Reduced for faster run; original was 20
batch_size = 128
learning_rate = 0.001
...
noise_stds = [0.0, 0.1, 0.2, 0.3, 0.4]            # Retrieval
...
# If separated ~ integrated but with less "resource" (lower total proxy), separation is efficient
